...
.login-canvas {
    background: #1E293B;
    border-radius: 20px;
    box-shadow: 0 12px 48px rgba(0,0,0,0.5), 0 0 0 1px rgba(56,189,248,0.06);
...
.login-canvas input::placeholder {
...
<div style="text-align:center;padding:0.5rem 0 1.5rem;
  ...
  <div style="margin-top:8px;font-size:14px;font-weight:500;color:#94A3B8;
      letter-spacing:-0.01em;line-height:1.5;">
    Transform documents into<br>
    <span style="color:#38BDF8;font-weight:600;">interactive learning modules</span>
  </div>
</div>
""",
