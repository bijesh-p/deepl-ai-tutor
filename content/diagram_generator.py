...
_SYSTEM = (
    ...
    "Never use a double-quote character or a backslash-escaped quote (\\\") inside a "
    "label — Mermaid does not support escaped quotes, and it produces a syntax error. "
...
def _sanitize_mermaid(code: str) -> str:
    ...
    Mermaid does not support backslash-escaped quotes inside labels;
    replace them with the HTML entity equivalent.
    """
